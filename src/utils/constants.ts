...
export const EXPERIENCE = [
  {
    ...
    locationNl: 'Utrecht, Nederland',
    period: 'Sep 2022 – Heden',
    title: 'Software Engineer',
    titleNl: 'Software Engineer',
    description: 'Building AI-powered solutions and enterprise middleware platforms for major Dutch companies including Eneco.',
    descriptionNl: 'Bouwen van AI-oplossingen en enterprise middlewareplatformen voor grote Nederlandse bedrijven, waaronder Eneco.',
  ...
  },
  {
    ...
    titleNl: 'Senior Developer / Oplossingsarchitect',
    description: 'Led 3 enterprise applications (Tapeline, Hammer, User Management). Introduced TDD and coached team members.',
    descriptionNl: 'Leidde 3 enterprise-applicaties (Tapeline, Hammer, Gebruikersbeheer). Introduceerde TDD en coachte teamleden.',
  ...
  },
  {
    ...
    descriptionNl: 'Bouwde Personal Finance Planner — een rekentool voor financieel adviseurs. Implementeerde DDD, TDD en D3.js-visualisaties.',
  ...
  },
  {
    ...
    descriptionNl: 'Medisch EPD-systeem (MediTop), blockchain-energiesysteem (Stedin) en AR/VR havenbeheerapplicatie.',
  ...
  },
  {
    ...
    descriptionNl: 'Bouwde 7+ clientapplicaties, waaronder loyaliteitsplatformen, medische systemen en archiveringsoplossingen.',
  ...
  },
  {
    ...
    location: 'Egypt',
    locationNl: 'Egypte',
    period: 'Okt 2014 – Jun 2015',
    title: 'Software Engineer Trainee',
    titleNl: 'Software Engineering Stagiair',
    description: 'Professional diploma in Software Engineering. Built foundational enterprise projects during intensive program.',
    descriptionNl: 'Professioneel diploma Software Engineering. Bouwde fundamentele enterprise-projecten tijdens intensief programma.',
